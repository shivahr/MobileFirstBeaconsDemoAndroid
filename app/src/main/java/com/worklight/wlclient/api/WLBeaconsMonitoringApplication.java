...
public class WLBeaconsMonitoringApplication extends Application implements BootstrapNotifier, RangeNotifier {
	...
	private com.worklight.wlclient.api.WLBeaconsAndTriggersJSONStoreManager getJSONStoreManager() {
		return com.worklight.wlclient.api.WLBeaconsAndTriggersJSONStoreManager.getInstance(getApplicationContext());
	}
